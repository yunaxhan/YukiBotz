          ...
          switch (type) {
                ...
                if ( global.db.data.users[m.sender].batu > benteng * count ) {
               	...
               	global.db.data.users[m.sender].batu >= benteng * count
                    ...
                    global.db.data.users[m.sender].batu -= benteng * count
                       conn.reply(m.chat, `berhasil membangun benteng`, m)
                       } else conn.reply(m.chat, `Sda Kamu tidak cukup untuk membangun benteng yg senilai ${benteng * count }Kayu ${benteng * count}batu`, m)
                          break
                           case 'pertanian':
                    ...
                    user.batu -= pertanian * count
                       } else conn.reply(m.chat, `Sda Kamu tidak cukup untuk membangun pertanian yg senilai ${pertanian * count }Kayu ${pertanian * count}batu`, m)
                      break
                        case 'camptroops':
                        case 'camptroop':
                   if ( user.batu > camptroops * count ) {
                    ...
                    user.batu -= camptroops * count
                    } else conn.reply(m.chat, `Sda Kamu tidak cukup untuk membangun kamp pasukan yg senilai ${camptroops * count }Kayu ${camptroops * count}batu`, m)
                   ...
                   user.batu >= pertambangan * count
                    ...
                    user.batu -= pertambangan * count 
                    } else conn.reply(m.chat, `Sda Kamu tidak cukup untuk membangun pertanian yg senilai ${pertambangan * count }Kayu ${pertambangan * count}batu`, m)
                    ...
                    } else conn.reply(m.chat, `Sda Kamu tidak cukup untuk membangun pertanian yg senilai ${rumahsakit * count }Kayu ${rumahsakit * count}batu`, m)
                       break
...
handler.help = ['build *<text>*', 'upgrade *<sell|buy> <text>*']
handler.tags = ['rpg']
handler.owner = false
